...
// This is sourced from: https://stackoverflow.com/a/75757270 under CC BY-SA 4.0
...
#Preview {
    WrappingHStack(horizontalSpacing: 5) {
        TagPill(Tag.from("#温かい日")!)
        TagPill(Tag.from("#運動")!)
        TagPill(Tag.from("#Warm Day")!)
        TagPill(Tag.from("#French")!)
        TagPill(Tag.from("#Japanese")!)
        TagPill(Tag.from("#Marmelade")!)
        //TagPill(Tag.from("What if it is just really really really too long for the screen oh okay thats acceptable")!)
    }
}
